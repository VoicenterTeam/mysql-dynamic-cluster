...
|---|---|---|
| Global pool settings key | `globalPoolSettings` ([README.md:258](../README.md)) | `defaultPoolSettings` ([schema.ts:11](../src/configs/schema.ts#L11)) |
| Log level | `logLevel: LOGLEVEL` enum (`QUIET`/`REGULAR`/`FULL`) ([README.md:392-402](../README.md)) | `logs.level`: one of `'info' \| 'error' \| 'debug' \| 'warn' \| 'silent'` ([schema.ts:200-205](../src/configs/schema.ts#L200-L205), [LoggerInterfaces.ts:3-9](../src/types/LoggerInterfaces.ts#L3-L9)) |
| Log destination | `useConsoleLogger`, `useAmqpLogger` booleans ([README.md:348-376](../README.md)) | `logs.output`: comma-separated string (`'console'`, `'console,amqp'`) ([schema.ts:206-211](../src/configs/schema.ts#L206-L211), [Logger.ts:20-39](../src/utils/Logger.ts#L20-L39)) |
| AMQP config | `amqpLoggerSettings.log_amqp[]` — array of `{connection, channel}` ([README.md:723-762](../README.md)) | `amqp_logs.{topic, connection_master, exchage, queue, bindings, prefetch}` — single flat block ([schema.ts:213-306](../src/configs/schema.ts#L213-L306)) |
| Redis config | flat `redisSettings: {keyPrefix, expire, …}` plus `useRedis` boolean ([README.md:288-294](../README.md), [README.md:636-704](../README.md)) | `redis: {enabled, keyPrefix, expire, …}` — `enabled` lives inside the block ([schema.ts:155-198](../src/configs/schema.ts#L155-L198)) |
| Redis client injection | `redis: <RedisInstance>` ([README.md:269-278](../README.md)) | `redisInstant: <RedisInstance>` — stripped from user settings before the convict load ([schema.ts:125-130](../src/configs/schema.ts#L125-L130), [index.ts:13-14](../index.ts#L13-L14)) |
| Config delivery | Object passed directly to `createPoolCluster` ([README.md:169-185](../README.md)) | Convict schema + env-var overlay + optional JSON files + user settings deepmerged on top ([configs/index.ts:7-25](../src/configs/index.ts#L7-L25), [Settings.ts:17-30](../src/utils/Settings.ts#L17-L30)) |
| AMQP transport | [`@voicenter-team/amqp-logger`](https://www.npmjs.com/package/@voicenter-team/amqp-logger) ([README.md:20](../README.md)) | [`@voicenter-team/failover-amqp-pool`](https://www.npmjs.com/package/@voicenter-team/failover-amqp-pool) via a winston transport ([Logger.ts:2](../src/utils/Logger.ts#L2), [package.json:42](../package.json#L42)) |
...
[README.md:457-463](../README.md)), load factors are still
`{key, multiplier}` pairs ([schema.ts:51-58](../src/configs/schema.ts#L51-L58),
[README.md:477-482](../README.md)), and pool selection remains
filter-then-sort by pool status then pool score
([architecture.md](architecture.md), [README.md:9-13](../README.md)). The
...
([index.ts:11-18](../index.ts#L11-L18), [README.md:168-220](../README.md));
